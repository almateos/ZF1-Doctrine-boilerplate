...
class WebGuy extends \Codeception\AbstractGuy
{
    ...
    /**
     *
     * @see WebHelper::haveNoEmails()
     *
     * ! This method is generated. DO NOT EDIT. !
     * ! Documentation taken from corresponding module !
     */
    public function haveNoEmails() {
        $this->scenario->action('haveNoEmails', func_get_args());
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    /**
     *
     * @see WebHelper::seeAnEmailContaining()
     *
     * ! This method is generated. DO NOT EDIT. !
     * ! Documentation taken from corresponding module !
     */
    public function seeAnEmailContaining($text) {
        $this->scenario->assertion('seeAnEmailContaining', func_get_args());
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
